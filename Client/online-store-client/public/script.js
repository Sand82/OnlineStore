...
function highlightCircle(circleSelect, direction) {
  ...
  circleStore.forEach((circle) => {
    if (circle === circleSelect) {
      circle.classList.add("circleFill");
    } else {
      circle.classList.remove("circleFill");
    }
  });
}
